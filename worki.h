...
// Struktura reprezentujaca worek i pamietajaca grupe (wiecej w worki.cpp)
// ktora trzyma przedmioty i worki wlozone do tego worka
struct worek {
    worek* par;
    int ctr;
    int num;
...
// Struktura reprezentujaca przedmiot, ktora pamieta grupe
// w ktorej przedmiot sie znajduje
struct przedmiot {
    worek* par;
};
